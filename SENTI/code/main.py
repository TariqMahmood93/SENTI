# import argparse
# import sys
# from injecting_null_2 import run_null_injection
...
#     )
#     p.add_argument("--path", default="/content/drive/MyDrive/Project-ESWA/Data")
#     p.add_argument("--datasets", nargs="+", default=["adultsample"])
#     p.add_argument("--seeds", nargs="+", type=int, default=[1234])
#     p.add_argument("--cum_pcts", nargs="+", type=float, default=[0.05, 0.05, 0.1, 0.2])
